...
desc.GBD = `
<i>"A statement advocating an alternative approach to the COVID-19 pandemic. [...] The declaration was sponsored by the American Institute for Economic Research (AIER), a libertarian think tank based in Great Barrington, Massachusetts."</i>, [Wikipedia](https://en.wikipedia.org/wiki/Great_Barrington_Declaration)
`

desc.CG = `
Nonprofit company incorporated in the UK and Wales, [ollateralglobal.org](https://collateralglobal.org/about)

The scientific advisory board comprises 3 Great Barrington co-authors.
`

desc.CKF = `
[Wikipedia](https://en.wikipedia.org/wiki/Koch_family_foundations#Charles_Koch_Foundation)

The Koch brothers, also known as the ["funders of climate disinformation"](https://www.campaigncc.org/climate_change/sceptics/funders)

"Groups Aligned with Right-Wing Megadonors Are Promoting Coronavirus Protests", [prwatch.org](https://www.prwatch.org/news/2020/04/13568/groups-aligned-right-wing-megadonors-are-promoting-coronavirus-protests)

"The Lockdown Backlash May Be the New Tea Party Movement", [nymag.com](https://nymag.com/intelligencer/2020/04/the-lockdown-backlash-may-be-the-new-tea-party-movement.html)
`

desc.AIER = `
American Institute for Economic Research (AIER), a libertarian think tank based in Great Barrington, Massachusetts.

<i>Reporting on the declaration, Byline Times journalist Nafeez Ahmed has described the AIER as a "institution embedded in a Koch-funded network that denies climate science while investing in polluting fossil fuel industries".</i>

Received a US$68,100 donation from the Charles Koch Foundation.

[Wikipedia](https://en.wikipedia.org/wiki/Great_Barrington_Declaration#Sponsor)
`

// Jay Bhattacharya
desc.jb = `
Professor of Medicine at [Stanford University](https://profiles.stanford.edu/jay-bhattacharya)
...
// Martin Kulldorff
desc.mk = `
Professor of medicine at Harvard Medical School and a biostatistician and epidemiologist at the Brigham and Women's Hospital.

Co-Author of The Great Barrington Declaration

Scientific Advisory Board [Collateral Damage](https://collateralglobal.org/about)

Wrote a prominent e-mail to Anders Tegnell and Johan Giesecke. He thanks them <i>"for your Covid-19 work, not only important for Sweden but also for the rest of the world."</i>.

<img width="468" src="./img/doc-email-kulldorff-01.png" />
`

// Sunetra Gupta
desc.sg = `
Professor of Theoretical Epidemiology, [University of Oxford](https://www.zoo.ox.ac.uk/people/professor-sunetra-gupta#/)
...
// Johan Giesecke
desc.jg = `
Physician and Professor Emeritus at the Karolinska Institute in Stockholm.
`
